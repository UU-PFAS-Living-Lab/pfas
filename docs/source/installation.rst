...
.. note:: 
	If you're new to Python or simply want to quickly explore the basic features of ``pfas`` without installing it locally, you can try one of our :doc:`/tutorials`.


Step 1: Install Python
----------------------

Pfas requires Python 3.9 or higher. If you don't have Python installed or your Python version is lower than 3.9, you will need to install or upgrade Python.
