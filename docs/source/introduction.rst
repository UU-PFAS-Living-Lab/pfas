...
solutions implemented in CXTFIT v. 2.0 (Toride et al. 1995) with extensions for
PFAS-specific retention processes, including air--water interfacial
adsorption, following Guo et al. (2022). We acknowledge the original authors of both papers for their contributions. 
