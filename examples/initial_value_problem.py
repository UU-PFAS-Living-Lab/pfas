...
def _(mo):
    ...
    We construct an **initial condition array** where the top 50% of grid nodes are assigned a PFAS concentration of 1 mg/L and the bottom 50% start at 0. We define our sorption parameters here arbitrarily, just to illustrate the movement of the plume.
    """)
    return
...
def _(
    ...
    initial_concentration[:cutoff] = 1  # top half set to 1 mg/L
